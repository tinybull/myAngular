...
ASTCompiler.prototype.compile = function (text) {
    ...
    return new Function(
        ...
        ensureSafeObject,
        ensureSafeFunction,
        ifDefined);  //这个函数是调用parse服务返回的结果，函数体为动态解析的
    /* jshint -W054 */

    /**
     * (function(s,l){
        var v0;
        if(l&&('aKey' in l)){v0=(l).aKey;}
        if(!(l&&('aKey' in l))&& s){v0=(s).aKey;}
        return v0;
       })

     (function(s,l) {
        var v0;
        if(l&&('aFunction' in l)){v0=(l).aFunction;}
        if(!(l&&('aFunction' in l))&& s){v0=(s).aFunction;}
