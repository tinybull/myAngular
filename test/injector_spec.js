describe('injector', function () {
    ...
    it('uses the prototype of the constructor when instantiating', function () {
        ...
        expect(instance.getValue()).toBe(instance.v);
        expect(instance.__proto__).toBe(BaseType.prototype);
    });
    ...
    describe('provider', function () {
        ...
        it('injects the $get method of a provider lazily', function () {
            ...
            module.provider('a', ['bProvider',function (bProvider) {    //bProvider必须先于aProvider注册！
                bProvider.c=4;
                this.$get=_.constant(1);
            }]);
            var injector = createInjector(['myModule']);

            expect(injector.get('b')).toBe(3); //5         //here dependency of b is instantiated
        });
        ...
        describe('restrict of injecting provider and instance', function () {
            it('does not inject an instance to a provider constructor function', function () {
                ...
                module.provider('b', function BProvider(a) { //dependency of a is instantiated by aProvider
                    this.$get = function () {
                        return a;
                    };
                });
